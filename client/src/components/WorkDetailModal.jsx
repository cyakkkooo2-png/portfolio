          ...
          {work.type === 'article' && work.content && (
            <div className="mt-4 space-y-4 pt-5 leading-relaxed" style={{ borderTop: '1px solid rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.62)', lineHeight: 1.9 }}>
              {isArticleHtml(work.content) ? (
                <article
                  className="article-body space-y-4 [&_.article-align-center]:text-center [&_a]:text-orange-300 [&_a]:underline [&_blockquote]:my-6 [&_blockquote]:border-l-4 [&_blockquote]:border-orange-500 [&_blockquote]:pl-4 [&_blockquote]:italic [&_figcaption]:mt-2 [&_figcaption]:text-center [&_figcaption]:text-sm [&_figcaption]:text-white/45 [&_figure]:my-7 [&_h1]:mt-8 [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:text-white [&_h2]:mt-8 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-white [&_h3]:mt-6 [&_h3]:text-xl [&_h3]:font-bold [&_h3]:text-white/90 [&_img]:my-5 [&_img]:max-h-[620px] [&_img]:w-full [&_img]:rounded-xl [&_img]:object-contain [&_li]:ml-5 [&_li]:list-disc [&_ol]:my-5 [&_ol]:space-y-2 [&_p]:mb-5 [&_ul]:my-5 [&_ul]:space-y-2"
