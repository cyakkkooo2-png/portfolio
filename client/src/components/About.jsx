    ...
    <section id="about" className="relative px-6 py-24 md:px-20" style={{ background: '#f3f3f3' }}>
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 text-center">
          <h2 className="text-gray-900" style={{ ...fnt(t?.aboutTitle, 'Playfair Display', 48, '#111111'), lineHeight: 1.1 }}>
        ...
        <div className="grid items-center gap-14 md:grid-cols-[215px_1fr]">
          ...
          <div>
            <RichText as="h3" value={t?.aboutHeadline} fallback="创意驱动，无限进步" className="text-2xl leading-snug text-gray-900 md:text-3xl" />
